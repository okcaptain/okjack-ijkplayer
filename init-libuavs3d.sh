...
echo "== pull libuavs3d base =="
sh $TOOLS/pull-repo-base.sh $IJK_LIBUAVS3D_UPSTREAM $IJK_LIBUAVS3D_LOCAL_REPO

function pull_fork()
{
    echo "== pull libuavs3d fork $1 =="
    sh $TOOLS/pull-repo-ref.sh $IJK_LIBUAVS3D_FORK android/contrib/libuavs3d-$1 ${IJK_LIBUAVS3D_LOCAL_REPO}
    cd android/contrib/libuavs3d-$1
